  ...
  return (
    <>
      <style>{`
        ...
        .menu-item-logout { padding: 14px 20px; color: #ff6b6b; font-family: "Nunito", sans-serif; font-size: 15px; font-weight: 600; cursor: pointer; border-top: 1px solid #1a3a5c; transition: all 0.2s; display: flex; align-items: center; gap: 10px; white-space: nowrap; }
        .menu-item-logout:hover { background: rgba(255,107,107,0.1); color: #ff4444; padding-right: 28px; }
      `}</style>
