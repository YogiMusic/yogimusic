    ...
    <main style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px' }}>
        <div style={{ backgroundColor: '#0d1f35', borderRadius: '16px', padding: '28px', border: '1px solid #1a3a5c' }}>
          ...
          <a href="/asfur.pdf" download style={{ backgroundColor: '#1a6abf', color: 'white', border: 'none', padding: '14px 24px', borderRadius: '10px', fontWeight: 'bold', cursor: 'pointer', width: '100%', fontSize: '16px', fontFamily: '"Nunito", sans-serif', display: 'block', textAlign: 'center', textDecoration: 'none' }}>להורדה</a>
        </div>
      </div>
    </main>
  )
